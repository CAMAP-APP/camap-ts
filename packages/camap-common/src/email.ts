import yup from "./validators/custom-yup";

// From yup : https://github.com/jquense/yup/blob/99aa25787a8ff15fe42e54db88ec3ed547357302/src/string.ts#L19
...
export const isEmail = (text: string): boolean => {
  return yup.string().email().required().isValidSync(text);
};

export const containsEmail = (text: string) => {
  return CONTAINS_EMAIL_REGEX.test(text);
};